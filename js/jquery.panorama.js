...
(function($) {
	$.fn.panorama = function(options) {
		this.each(function(){ 
			...
			panoramaContainer.css('height', 100+'%').css('overflow', 'hidden').wrap("<div class='panorama-viewport'></div>").parent().css('width',settings.viewport_width+'%').css('height', settings.viewport_width+'%')
			...
			panoramaViewport.css('height', 100+'%').css('overflow', 'hidden').find('a.panorama-control-left').bind('click', function() {
